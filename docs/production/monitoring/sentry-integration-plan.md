...
**Related docs:** [monitoring-guide.md](../../monitoring-guide.md), [MONITORING_COMPLETE.md](../../../pranidoctor-web/docs/MONITORING_COMPLETE.md), [ARCHITECTURE_DECISION_RECORD.md](../../../pranidoctor-backend/docs/ops/ARCHITECTURE_DECISION_RECORD.md)
...
- [ ] 7-day burn-in per [PRODUCTION_READINESS_REPORT](../../launch/PRODUCTION_READINESS_REPORT.md)
...
Per [LAUNCH_DAY_RUNBOOK](../../launch/LAUNCH_DAY_RUNBOOK.md):
