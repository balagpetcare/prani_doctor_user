    ...
    return Scaffold(
      ...
      body: listAsync.when(
        ...
        error: (e, _) => FarmFeedback.error(
          context,
          message: e.toString(),
          onRetry: () => ref.read(farmListProvider.notifier).reload(forceRefresh: true),
        ),
        data: (state) {
          if (state.farms.isEmpty && state.search.isEmpty && filter == FarmFilter.all) {
          ...
          return RefreshIndicator(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                if (state.fromCache) SliverToBoxAdapter(child: FarmFeedback.offlineHint(context)),
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        FilterChip(
                          ...
                          onSelected: (_) {
                            ref.read(farmFilterProvider.notifier).state = FarmFilter.all;
                            ref.read(farmListProvider.notifier).applyQuery();
                          },
                        ),
                        FilterChip(
                          ...
                          onSelected: (_) {
                            ref.read(farmFilterProvider.notifier).state = FarmFilter.hasAnimals;
                            ref.read(farmListProvider.notifier).applyQuery();
                          },
                        ),
                      ],
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return FarmCard(
                          farm: farm,
                          onTap: () => context.push(AppRoutes.farmDetail(farm.id)),
                        );
                      },
                    ),
                  ),
