        ...
        Expanded(
          child: listAsync.when(
            ...
            error: (e, _) => NotificationFeedback.error(
              context,
              message: e.toString(),
              onRetry: () => ref.read(notificationListProvider.notifier).reload(forceRefresh: true),
            ),
            data: (state) {
              ...
              return RefreshIndicator(
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    if (state.fromCache) SliverToBoxAdapter(child: NotificationFeedback.offlineHint(context)),
                    for (final section in state.grouped) ...[
                      SliverToBoxAdapter(
                        child: Padding(
                        ...
                        sliver: SliverList(
                          delegate: SliverChildBuilderDelegate(
                            (context, index) => Padding(
                              ...
                              child: NotificationCard(notification: section.items[index]),
                            ),
