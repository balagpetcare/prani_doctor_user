              ...
              return Card(
                child: ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () async {
                      final result = await ref.read(aiPhase8RepositoryProvider).dismissAlert(alert.id);
              ...
              return Card(
                child: ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () async {
                      final result = await ref.read(aiPhase8RepositoryProvider).dismissFollowUp(item.id);
                      if (!context.mounted) return;
                      result.when(
