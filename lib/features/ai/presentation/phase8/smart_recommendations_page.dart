        ...
        data: (items) {
          if (items.isEmpty) {
            return ListView(
              ...
              children: const [
                AiDisclaimerBanner(feature: AiDisclaimerFeature.recommendations),
                SizedBox(height: 24),
                Center(child: Text('এখন কোনো পরামর্শ নেই')),
              ],
            );
          }
          return ListView.separated(
            ...
            itemBuilder: (context, i) {
              if (i == 0) {
                return const AiDisclaimerBanner(
                  feature: AiDisclaimerFeature.recommendations,
                );
              }
              if (i == items.length + 1) {
                return const AiDisclaimerFooter(
                  feature: AiDisclaimerFeature.recommendations,
                );
              }
