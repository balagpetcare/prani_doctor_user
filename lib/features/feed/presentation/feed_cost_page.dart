        ...
        data: (cost) {
          return RefreshIndicator(
            onRefresh: () async {
              ref.invalidate(feedCostProvider);
              ref.invalidate(feedAnalyticsProvider);
              await ref.read(feedCostProvider.future);
            },
            child: ListView(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${l10n.feedTotalAmount}: ${cost.totalAmount.toStringAsFixed(2)}',
                        ),
                      ],
                    ),
                  ),
                ...
                if (cost.daily.isEmpty)
                  ...
                  MilkSimpleBarChart(
                    labels: cost.daily
                        .map((d) => d.label.substring(5))
                        .toList(),
                    values: cost.daily.map((d) => d.costBdt).toList(),
                  ),
                const SizedBox(height: 16),
                Text(
                  l10n.feedWeeklyCostTitle,
                  style: Theme.of(context).textTheme.titleMedium,
                ),
                ...
                if (cost.byAnimal.isEmpty)
                  ...
                  ...cost.byAnimal.map(
                    (a) => ListTile(
                      ...
                      subtitle: Text(
                        '${l10n.feedCostValue(a.costBdt)} · ${a.amount.toStringAsFixed(2)}',
                      ),
                    ),
                  ),
                ...
                analyticsAsync.when(
                  ...
                  error: (_, _) => Text(l10n.feedAnalyticsError),
                  data: (analytics) => Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      Text(
                        l10n.feedAnalyticsTitle,
                      ...
                      ListTile(
                        ...
                        trailing: Text(
                          l10n.feedCostValue(
                            analytics.efficiency.costPerAnimal,
                          ),
                        ),
                      ),
                      ListTile(
                        ...
                        trailing: Text(
                          l10n.feedCostValue(
                            analytics.efficiency.avgCostPerRecord,
                          ),
                        ),
                      ),
                    ],
