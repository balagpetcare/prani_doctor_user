...
abstract class LocalCacheContract {
  ...
  static String financeExpenseDetailKey(String id) => 'finance_expense_detail:$id';
  static String financeIncomeDetailKey(String id) => 'finance_income_detail:$id';
  static const financeExpenseDraftKey = 'finance_expense_draft_new';
  static String financeExpenseEditDraftKey(String id) => 'finance_expense_draft:$id';
  static const financeIncomeDraftKey = 'finance_income_draft_new';
  static String financeIncomeEditDraftKey(String id) => 'finance_income_draft:$id';
  ...
  static String supportTicketDetailKey(String id) => 'support_ticket_detail:$id';
  static const supportHelpKey = 'support_help_snapshot';
  static const aiActiveSessionKey = 'ai_active_session';
  static String aiConversationKey(String sessionId) => 'ai_conversation:$sessionId';
  ...
  static const notificationsUnreadCountKey = 'notifications_unread_count_snapshot';
  ...
  static const dashboardTtl = Duration(hours: 12);
